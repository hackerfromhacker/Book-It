											...
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter"><span class="counter-anim">
														<?php
																$result = $db->prepare("select count(*) from users where user_type='Customer'");
																$result->execute();
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter"><span class="counter-anim">
														<?php
																$result = $db->prepare("select count(*) from books");
																$result->execute();
																for($i=0; $row = $result->fetch(); $i++)
																{
																	echo"".$row['count(*)']."";
													...
													<span class="weight-500 uppercase-font txt-light block">Products</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter"><span class="counter-anim">
															<?php
																$result = $db->prepare("select count(*) from booking_books");
																$result->execute();
																for($i=0; $row = $result->fetch(); $i++)
																{
																	echo"".$row['count(*)']."";
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-light block counter"><span class="counter-anim">															
                                                            <?php
																$result = $db->prepare("select count(*) from complaint");
																$result->execute();
																for($i=0; $row = $result->fetch(); $i++)
																{
																	echo"".$row['count(*)']."";
													...
													<span class="weight-500 uppercase-font txt-light block">Complaint</span>
												</div>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table class="table table-hover mb-0">
												...
												<tbody>
													<?php
													$result = $db->prepare("select * from booking_books where sstatus='pending' limit 6");
														$result->execute();
