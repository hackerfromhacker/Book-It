		...
		<div class="page-wrapper">
            <div class="container-fluid pt-25">
				...
				<h2>Order Request</h2>
					<hr>
       			<?php
                        $result = $db->prepare("select * from booking_books where ULog_Id='$user_id' and sstatus='Pending'");
                        $result->execute();
									...
									<article class="col-item">
                                        ...
                                        <div class="info">
                                        	<table class="table table-bordered">
												...
												<a href="actions/booking_prd_cancel.php?prbk_id=<?php echo $rows['prbk_id'];?>" class="btn btn-block btn-danger">CANCEL</a>
										</div>										
									</article>
								</div>
							</div>	
