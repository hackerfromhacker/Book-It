							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<table id="datable_1" class="table table-hover display  pb-30">
										...
										<tbody>
											<?php
											$qry_user = $db->prepare("SELECT * FROM books");
											$qry_user->execute();
											...
											?>
												<tr>
                                                    ...
                                                    <td><?php echo $rows['pyr'] ?></td>
                                                    <td><?php echo $rows['category'] ?></td>
													<td><?php echo $rows['qty'] ?></td>
													<td><?php echo $rows['price'] ?></td>
													<td><?php echo $rows['description'] ?></td>
													<td><img src="../photos/<?php echo $rows['photo_1'] ?>" width="150"></td>
                                                    <td><a href="search_books_view_payment.php?id=<?php echo $rows['id'] ?>" class="btn btn-block btn-danger">REQUEST</a></td>
